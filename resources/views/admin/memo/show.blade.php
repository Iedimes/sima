...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-3">
                <p class="card-text"><strong>ORIGEN:</strong> {{$memo->post_odependencia->name}}</p>
            </div>
            <div class="form-group col-sm-4">
                <p class="card-text"><strong>DESTINO:</strong> {{$memo->post_ddependencia->name}} </p>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-sm-2">
                            ...
                            <td>@{{ item.id }}</td>
                                ...
                                <td>
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-auto" v-if="item.estado.id==3">
                                        ...
                                        <div class="col-auto" v-if="item.estado.id==1">
